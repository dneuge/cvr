...
**
** Created: Sun Dec 1 16:45:47 2013
...
static const char qt_meta_stringdata_VideoSurface[] = {
    "VideoSurface\0\0newFrame()\0"
};
...
const QMetaObjectExtraData VideoSurface::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VideoSurface::staticMetaObject = {
    { &QAbstractVideoSurface::staticMetaObject, qt_meta_stringdata_VideoSurface,
      qt_meta_data_VideoSurface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VideoSurface::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoSurface))
